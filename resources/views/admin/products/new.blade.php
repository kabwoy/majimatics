...
@section('content')
    <div class="p-20 mt-[4rem]">
        ...
        <form action="/admin/products" method="post">
            ...
            <div>
                <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Desription</label>
                <textarea id="message" name="description" rows="4" class="block mb-2 p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500" placeholder="Description...."></textarea>
            </div>
