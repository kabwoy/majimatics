        ...
        <div class="rounded-lg sm:border-2 px-4 lg:px-24 py-16 lg:max-w-xl sm:max-w-md w-full text-center">
            ...
            <div id="alert-additional-content-3" class="p-4 mb-4 text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert">
                <div class="flex items-center">  
                  ...
                  <h3 class="text-lg font-medium">Account Created</h3>
                </div>
            ...
            @endif
            <form class="text-center" action="/auth/login" method="post">
                @csrf
                <h1 class="font-bold tracking-wider text-3xl mb-8 w-full text-gray-600 dark:text-white">
                    Login 
                </h1>
                <div class="py-2 text-left">
                    <input type="email" name="email" class="bg-gray-200 border-2 border-gray-100 focus:outline-none bg-gray-100 block w-full py-2 px-4 rounded-lg focus:border-gray-700 " placeholder="Email" />
                </div>
                <div class="py-2 text-left">
            ...
            <div class="text-center mt-12">
                ...
                <a href="/auth/signup" class="font-light text-md text-indigo-600 underline font-semibold hover:text-indigo-800">Create One</a>
            </div>
        </div>
    </div>
</section>
