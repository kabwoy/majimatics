...
<div class="flex justify-end bg-red-200">
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex mt-[4rem] items-center justify-between">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            ...
            <div>
                <span class="relative z-0 inline-flex justify-end shadow-sm rounded-md">
                    {{-- Previous Page Link --}}
                    @if ($paginator->onFirstPage())
